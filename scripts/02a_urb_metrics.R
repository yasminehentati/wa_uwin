...
p_load(dplyr,sp,raster,here,sf,mapview, # note that mapview is somewhat demanding, 
       # consider skipping mapview functions if your computer is slow -
       # these are just used to check that shapefiles geometry is correct
       rgdal,raster, rgeos, remotes, tidycensus,
       tidyr,terra,spatialEco,readr,ggfortify,
       exactextractr,spatstat,spdep,landscapemetrics,
       tmap, viridis, gghighlight)
...
# projection is albers conical equal area 
